...
% error rate for an 802.11ad SC [ <#14 1> ] link with a TGay
% millimeter-wave channel [ <#14 2> ] at a selection of SNR points. At each
...
% [-20, +20] ppm [ <#14 1> ]. In this example, a clock accuracy of 20ppm is
...
% # AWGN is added to the received waveform. <docid:comm_ref#buiamu7-1
...
% channel is created and configured with <docid:comm_ref#buiamu7-1
% comm.AWGNChannel>. To enable the use of parallel computing for increased
% speed comment out the <docid:matlab_ref#buhafgy-1 for> statement and
% uncomment the <docid:matlab_ref#f71-813245 parfor> statement below.
...
% * <matlab:edit('dmgCFOEstimate.m') dmgCFOEstimate.m>
% * <matlab:edit('dmgPacketDetect.m') dmgPacketDetect.m>
% * <matlab:edit('dmgTimingAndChannelEstimate.m') dmgTimingAndChannelEstimate.m>
% * <matlab:edit('dmgSingleCarrierFDE.m') dmgSingleCarrierFDE.m>
% * <matlab:edit('dmgSTFNoiseEstimate.m') dmgSTFNoiseEstimate.m>
% * <matlab:edit('dmgUniqueWordPhaseTracking.m') dmgUniqueWordPhaseTracking.m>
